    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-center
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <ApplicationLogo class="h-16 w-auto bg-transparent text-white"/>
            </div>

            <div class="mt-16">
                <div class="font-medium text-center flex justify-center">
                    <div v-if="canLogin" class="sm:fixed text-center flex justify-center">
                        <Link
